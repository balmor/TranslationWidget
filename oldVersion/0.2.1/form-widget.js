...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        checkIfDataExist: function() {
            ...
            var $langLength = $thisElement.nextAll().eq(1).children('span').length,
                $langSpacing = $langLength * 4,
                $langWidth = 55 * $langLength + $langSpacing;
            if ($langWidth > 260) {
                $thisElement.width($langWidth + 14);
            }
        ...
        /**
         *    Add extra space when we have more languages
         */
        extraSpace: function() {
            var $langWidth = $(this.element).next().next('.language-tabs').width();
            $(this.element).css("width", $langWidth + 14);
        },
